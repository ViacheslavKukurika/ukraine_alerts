...
/*-----------------------------------------------------------------------------
  HomeScreen є початковим екраном застосунку та надає користувачеві вибір між 
двома основними сценаріями.

  Кнопка Alerts Map відкриває загальну карту актуальних повітряних тривог, а 
Region Alerts — екран перевірки конкретного регіону. Навігація виконується через
іменовані маршрути GoRouter. 
-----------------------------------------------------------------------------*/
