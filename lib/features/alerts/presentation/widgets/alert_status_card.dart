/*-----------------------------------------------------------------------------
  ...
  AlertStatusCard відображає інформаційний контент, що відповідає отриманому 
AirRaidStatus.

  Через switch віджет обирає потрібну іконку та текст для активної, часткової
або відсутньої повітряної тривоги. Для unknown повертається порожній віджет,
оскільки цей стан окремо обробляється батьківським екраном.

  Кожен варіант має ValueKey, завдяки чому AnimatedSwitcher розпізнає зміну
статусу та плавно анімує перехід між різними повідомленнями.
-----------------------------------------------------------------------------*/
